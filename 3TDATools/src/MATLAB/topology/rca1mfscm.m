function [ varargout ] = rca1mfscm( mfscm, distanceBoundOnEdges )
...
%tda.RCA1( { 'settingsFile=tda/data/rca1.settings.txt','supplyDataAs=distanceMatrix', param2 }, dm);  % compute 1-D persistence, using supplied parameters
tda.RCA1( { 'supplyDataAs=monotonicFunctionOnSimplicialComplexMatrix', param2 }, m);  % compute 1-D persistence, using supplied parameters
